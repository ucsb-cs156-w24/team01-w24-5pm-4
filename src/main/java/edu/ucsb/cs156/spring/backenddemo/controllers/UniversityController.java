...
public class UniversityController {
    ...
    @Operation(summary = "Get information abouut univerisities here", description = "JSON return format documented here: http://universities.hipolabs.com/search?name=Stanford")
    @GetMapping("/get")
    public ResponseEntity<String> getUniversity(
        @Parameter(name="name", description="name of university", example="Stanford") @RequestParam String name
